...
import { ImuMsg, IImuMsgAngle, imuRequest1, imuRequest2, imuResponse1$, imuResponse2$ } from '@/component/imu/imu-driver'
...
export const ImuInput = props => {
  ...
  //   .pipe(
  //     map(ImuMsg  => imuOutputFunctions[(ImuMsg as IImuMsgAngle).cmd](ImuMsg))))
  // useEffect(() => {
