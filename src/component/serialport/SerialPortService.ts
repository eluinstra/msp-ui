...
export const serialPortService = {
  ...
  onDataReceived: (ipcRenderer: IpcRenderer, fn: (object: any) => void): IpcRenderer => ipcRenderer.on(Command.onDataReceived, (event: IpcRendererEvent, buffer: Buffer) => fn(buffer)),
