...
export const ExampleChart2COM2 = props => {
  ...
  useEffect(() => {
    ...
    ApexCharts.exec('accelerochartcom2', 'updateSeries', [
      {
        data: dataAccx
      },
      {
